...
define('AVATARPATH_OLD', DISCUZ_ROOT.'convert/data/avatar/');
...
showmnextpage("乐Phone.CC用户数据搬迁中...".$ProcessNum*$page." / $totalnum",'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?'.'page='.($page+1).'&totalnum='.$totalnum);
